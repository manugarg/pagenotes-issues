...
if (suggestions !== null) { document.addEventListener('click', function(event) {
...
if (suggestions !== null) { document.addEventListener('keydown',suggestionFocus); }
...
(function(){
  ...
  */
  ...
  if (search !== null) { search.addEventListener('input', show_results, true); }
